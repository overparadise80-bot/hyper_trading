...
def refresh_sector_realtime():
    ...
    # 새로 들어온 종목 구독 등록 (FID 10=현재가, 11=거래량)
    added = new_codes - _subscribed_codes
    if added:
        kiwoom.dynamicCall(
            "SetRealReg(QString,QString,QString,QString)",
            REALTIME_SCREEN, ";".join(added), "10;11", "1")
...
def on_interval_m1():
    ...
    if is_m1_open():
        mod1.start_scan(on_complete=refresh_sector_realtime)
    else:
        print("모듈1 장외 - 스킵")
